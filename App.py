...
st.caption("Professional Interactive Charts • Actual MCX + Live COMEX • Full VC PMI + Gann + Fib")
...
# PROFESSIONAL INTERACTIVE COMEX CHART
...
fig.add_trace(go.Bar(x=df.index, y=df['Volume'], name="Volume", marker_color='rgba(128,128,128,0.3)', yaxis="y2"))

# VC PMI + Gann + Fib prediction lines
...
# MCX VIEW WITH YOUR ACTUAL PRICE
...
st.caption("Auto-refreshes every 30 seconds • Professional interactive charts • Enter actual MCX price above • Built exclusively for Satbeer • Kolkata")
